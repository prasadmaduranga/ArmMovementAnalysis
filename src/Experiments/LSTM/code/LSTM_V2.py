...
data_file = '../data/video_graph_features_400_samples.csv'
meta_data_file = '../data/sign_lang_meta_data.csv'
model_archive_file = '../models/LSTM_400sample_2023_02_02_V2.pt'
...
class LSTMClassifier(nn.Module):
    ...
    # input should have the format (batch_size, sequence_length, input_dim)
...
lstm = LSTMClassifier(input_dim, hidden_dim, output_dim=len(OUTPUT_CLASSES))
