        ...
        for landmark_file in filenames:
            ...
            with open(os.path.join(args.input_dir, landmark_file), 'r') as inputfile:
                with open(os.path.join(args.output_dir, 'features_' + Path(landmark_file).stem + '.csv'),
                    ...
                    feature_list = ['ID'] + left_hand_angle_headings + right_hand_angle_headings + body_angle_headings + left_hand_distance_headings + right_hand_distance_headings + body_distance_headings + video_metadata
